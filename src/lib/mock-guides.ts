...
const findHeroImage = (seed: string): ImagePlaceholder => {
    return {
        id: `guide-hero-${seed}`,
        description: `Landscape associated with guide ${seed}`,
        imageUrl: `https://picsum.photos/seed/guide-hero-${seed}/1600/900`,
        imageHint: 'landscape nature',
    }
}
...
export const mockGuides: Guide[] = [
    {
        ...
        heroImage: findHeroImage('amir-desert'),
        languages: ['Hebrew', 'English'],
        responseTime: '2 hours',
        verified: true,
        rating: 4.9,
        reviews: [
            { id: 'r1', author: 'John D.', avatarUrl: 'https://picsum.photos/seed/avatar1/48/48', rating: 5, text: "Amir's knowledge is immense. He showed us a side of the desert we never knew existed. Life-changing.", date: '2023-10-15' },
            { id: 'r2', author: 'Sarah K.', avatarUrl: 'https://picsum.photos/seed/avatar2/48/48', rating: 5, text: "A true spiritual guide. The silent hike at dawn was a highlight of our entire trip to Israel.", date: '2023-09-20' },
        ],
    },
    {
        id: '2',
        ...
        heroImage: findHeroImage('tamar-jerusalem'),
        languages: ['Hebrew', 'English', 'French'],
        responseTime: '4 hours',
        verified: true,
        rating: 4.8,
        reviews: [
             { id: 'r3', author: 'Michael B.', avatarUrl: 'https://picsum.photos/seed/avatar3/48/48', rating: 5, text: "Tamar made Jerusalem come alive. It felt like walking through history with a friend.", date: '2023-11-05' },
        ],
    },
    {
        id: '3',
        ...
        heroImage: findHeroImage('yoni-galilee'),
    ...
    },
    {
        ...
        heroImage: findHeroImage('maya-telaviv'),
        languages: ['Hebrew', 'English'],
    ...
    },
     {
        ...
        heroImage: findHeroImage('david-golan'),
    ...
    },
    {
        ...
        heroImage: findHeroImage('noa-coast'),
        languages: ['Hebrew', 'English'],
        responseTime: '2 hours',
        verified: true,
        rating: 4.8,
